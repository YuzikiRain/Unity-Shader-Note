...
如果使用变换顶点位置的矩阵来变换法线，当矩阵包含非统一缩放（或其他任何非线性变换）时，不能用于变换法线

假设在平面XY上，$scale=(1,2)$，那么模型空间下的顶点$A=(1,2)$和顶点$B=(2,1)$以及垂直于AB的法线$N=(1,1)$分别会变成顶点$A'=(1,4)$和顶点$B'=(2,2)$以及法线$N'=(1,2)$，然而垂直于A'B'的法线应该为$(2,1)$才对
